                ...
                <div class="news-standard-wrapper">
                    <div class="news-standard-items">
                        <div class="news-thumb">
                            <img src="{{asset('frontend/assets/img/news/post-1.jpg')}}" alt="img">
                            <div class="post">
                    ...
                    <div class="news-standard-items">
                        <div class="news-thumb">
                            <img src="{{asset('frontend/assets/img/news/post-2.jpg')}}" alt="img">
                            <div class="post">
                    ...
                    <div class="news-standard-items">
                        <div class="news-thumb">
                            <img src="{{asset('frontend/assets/img/news/post-3.jpg')}}" alt="img">
                            <div class="post">
                        ...
                        <div class="recent-post-area">
                            <div class="recent-items">
                                <div class="recent-thumb">
                                    <img src="{{asset('frontend/assets/img/news/pp3.jpg')}}" alt="img">
                                </div>
                            ...
                            <div class="recent-items">
                                <div class="recent-thumb">
                                    <img src="{{asset('frontend/assets/img/news/pp4.jpg')}}" alt="img">
                                </div>
                                <div class="recent-content">
                                    <ul>
                                        <li>
                            ...
                            <div class="recent-items">
                                <div class="recent-thumb">
                                    <img src="{{asset('frontend/assets/img/news/pp5.jpg')}}" alt="img">
                                </div>
                                <div class="recent-content">
                                    <ul>
                                        <li>
