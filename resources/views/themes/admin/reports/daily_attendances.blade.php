    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{ __('admin.daily_attendance_report') }}</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-end">
                                ...
                                <a href="{{ admin_url('reports/export_daily_attendance_from_view_report') }}"
                                    class="btn btn-default"><i class="fas fa-file-excel"></i></a>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="book-table" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @foreach ($daily_attendances as $book)
