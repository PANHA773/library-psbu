@extends(admin_layout('auth.main'))

@if(!settings()->avariable_register_page) 
...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="#" class="h1 login-title"><b>{{ settings()->site_name }}</b></a>
    </div>
    <div class="card-body">
      ...
      @csrf
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" name="password" id="password" placeholder="Password" autocomplete="new-passowrd">
          <div class="input-group-append">
            <div class="input-group-text">
