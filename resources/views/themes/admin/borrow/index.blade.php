            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover text-center">
                  ...
                  <tr class="text-center view-modal" data-id="{{ $borrowing->id}}" data-toggle="modal" data-target="#modal-lg">
                    ...
                    <td>
                      <form action="{{ admin_url('borrowers/'. $borrowing->id) }}" method="post">
                        ...
                        <a href="{{ admin_url('borrowers/repayed/'. $borrowing->id) }}" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i></a>
                        @elseif($borrowing->status == 'pending')
                        <a href="{{ admin_url('borrowers/borrowed/'. $borrowing->id) }}" class="btn btn-success btn-sm"><i class="fas fa-sync"></i></a>
                        @endif

                        @if($borrowing->status != 'repayed')
