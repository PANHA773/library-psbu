...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{__('admin.add_student')}}</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">{{__('admin.home')}}</a></li>
              <li class="breadcrumb-item active">{{__('admin.add_student')}}</li>
            </ol>
          </div>
        </div>
      </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" class="form-control" id="first_name"  placeholder="{{__('admin.enter_first_name')}}">
                            </div>
                            <div class="form-group">
                                <label for="nick_name">{{__('admin.nick_name')}}</label>
                                <input type="text" name="nick_name" class="form-control" id="nick_name" placeholder="{{__('admin.enter_nick_name')}}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control" id="phone" placeholder="{{__('admin.enter_phone')}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="email">{{__('admin.batch')}}</label>
                                <input type="text" name="batch" class="form-control" id="batch" placeholder="{{__('admin.enter_batch')}}">
                            </div>
                            <div class="form-group">
                                <label for="email">{{__('admin.skill')}}</label>
                                <input type="text" name="skills" class="form-control" id="skills" placeholder="{{__('admin.enter_skill')}}">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="last_name" class="form-control" id="last_name" placeholder="{{__('admin.last_name')}}">
                            </div>
                            <div class="form-group">
                                <label for="dob">{{__('admin.dob')}}</label>
                                <input type="date" name="dob" class="form-control" id="dob" placeholder="{{__('admin.enter_dob')}}">
                            </div>
                            <div class="form-group">
                                <label for="pob">{{__('admin.pob')}}</label>
                                <input type="text" name="pob" class="form-control" id="pob" placeholder="{{__('admin.pob')}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="shift" class="form-control" id="shift" placeholder="{{__('admin.enter_shift')}}">
                            </div>
