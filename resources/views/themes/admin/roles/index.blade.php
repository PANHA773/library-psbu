          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-primary btn-sm" style="float: right" href="{{ admin_url('settings/roles/create') }}">{{__('admin.add_role')}}</a>
              </div>
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover text-center">
                  ...
                  <tr class="text-center">
                    <td>{{ $role->name }}</td>
                    <td class="col-sm-2">
                      <form action="{{ admin_url('settings/roles/'. $role->id) }}" method="post">
                        @csrf
                        @method('DELETE')
                        <a href="{{ admin_url('settings/roles/'. $role->id.'/edit') }}" class="btn btn-success btn-sm"><i class="fas fa-key"></i></a>
                        {{-- <a href="{{ admin_url('settings/roles/'. $role->id.'/edit') }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a> --}}
