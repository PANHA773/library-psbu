...
class LicenseManager
{
    ...
    // Secret key for encryption. Do NOT store secrets in source control.
    // Prefer setting LICENSE_SECRET_KEY in your environment (for example in .env).
    protected $secretKey;

    public function __construct()
    {
        // Read from environment first. Keep a short, explicit fallback only for
        // backward-compatibility in local dev; rotate this value and remove
        // fallback in production.
        $this->secretKey = env('LICENSE_SECRET_KEY', '881d9aec31fa96d6fd3f5a6afd2abee6335ebc40f1cb1cee680d0e88e7771c9f90f50d8b9937e8e4f926473df19fe3473844');
    }
    ...
    public function isLicenseValid(): bool
    {
        ...
        // Check identifier matches current host
        $currentDomain = request()->getHost();
        if ($data['identifier'] !== $currentDomain) {
            return false;
        }
